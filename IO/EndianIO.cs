...
namespace System.IO
{
    ...
    public class EndianIO : IDisposable
    {
        ...
        public void SetEndian(EndianType endianType)
        {
            this.Close();

            if (this.EndianType != endianType)
                this.EndianType = endianType;
        ...
        public byte[] ToArray()
        {
            if (Stream.GetType() == typeof(XContent.StfsFileStream))
                return ((XContent.StfsFileStream)Stream).ToArray();
    ...
    public class EndianReader : BinaryReader
    {
        ...
        {
            byte[] buffer = new byte[Convert.ToInt64(count)];
        ...
        public byte[] ReadBytes(object Count, EndianType EndianType)
        {
            ...
            if ((BitConverter.IsLittleEndian && EndianType == EndianType.BigEndian)
                || (EndianType == EndianType.LittleEndian && !BitConverter.IsLittleEndian))
                Array.Reverse(array);
            return array;
        }
        ...
        public byte SeekNPeekByte(long pos)
        {
        ...
        public void SkipByte() { base.BaseStream.Position++; }
        public void SkipInt16() { base.BaseStream.Position += 2; }
        public void SkipInt32() { base.BaseStream.Position += 4; }
        public void SkipInt64() { base.BaseStream.Position += 8; }
        ...
        public int SeekNReadInt32(long Address)
        {
            base.BaseStream.Position = Address;
            return ReadInt32();
        }
        public float SeekNReadSingle(long Address)
        {
            base.BaseStream.Position = Address;
            return ReadSingle();
        }
        public byte SeekNReadByte(long Address)
        {
            base.BaseStream.Position = Address;
            return ReadByte();
        }
    ...
    public class EndianWriter : BinaryWriter
    {
        ...
        public void WriteInt16String(string str) { WriteInt16String(str, EndianType); }

        public void WriteInt16String(string str, EndianType EndianType)
        {
            Write((short)str.Length, EndianType);
        ...
        public void SeekNWrite(long position, uint Value)
        {
            base.BaseStream.Position = position;
            Write(Value);
        }
        public void SeekNWrite(long position, float value)
        {
            base.BaseStream.Position = position;
            Write(value);
        }
        public void SeekNWrite(long position, byte Value)
        {
            base.BaseStream.Position = position;
            WriteByte(Value);
        }
        ...
        public void SeekNWrite(long position, ushort Value)
        {
            base.BaseStream.Position = position;
            Write(Value);
        }
        ...
        public void StoreByte(object value)
        {
            long position = BaseStream.Position;
            WriteByte(value);
            BaseStream.Position = position;
        }
        public void StoreByte(object value, long position)
        {
            long origPos = base.BaseStream.Position;
            base.BaseStream.Position = position;
            WriteByte(value);
